...
class DeltaRestClient:
  ...
  def get_history_candles(self, symbol, resolution='1m', limit=200):
    """Fetch historical candles for a symbol and timeframe (resolution)."""
    import time
    end = int(time.time())
    start = end - limit * 60  # For 1m candles, limit*60 seconds ago
